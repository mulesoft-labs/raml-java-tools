 ...
 */
public class AddEqualsAndHashCodeWithSubclasses extends AllTypesPluginHelper {

    private final List<String> arguments;

    public AddEqualsAndHashCodeWithSubclasses(List<String> arguments) {
    ...
    private void createEquals(List<FieldSpec> specs, TypeSpec.Builder incoming) {
        ...
        MethodSpec.Builder method = MethodSpec.methodBuilder("equals")
                ...
                .addCode(CodeBlock.builder()
                        ...
                        .addStatement("if (o instanceof $T) return false", incoming.build().superinterfaces.get(0)).addStatement("$L other = ($L) o", incoming.build().name, incoming.build().name)
